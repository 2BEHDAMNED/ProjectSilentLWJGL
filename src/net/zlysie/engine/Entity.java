...
public class Entity {
	...
	public CollisionObject generateMesh(){
	    ...
	    if (indices.length > 0) {
	        ...
	        colObject.setWorldTransform(new Transform(new javax.vecmath.Matrix4f(new Quat4f(0, 0, 0, 1), new javax.vecmath.Vector3f(position.x, position.y, position.z), 1f)));
	        return colObject;
